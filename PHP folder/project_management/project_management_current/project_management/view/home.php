...
<!--            <input hidden value="--><?php //echo $value->id?><!--" >-->
            <th><button scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white" value="<?php echo $value->id;?>" name="projectId">
                    <?php echo $value->project_name; ?></button>
<!--            </th>-->
<!--            <td class="px-6 py-4">-->
<!--            </td>-->
<!--            <td class="px-6 py-4">-->
...
<!--            </td>-->
    ...
    <td class="px-6 py-4">
                        <form action="../index.php" method="post">
                            <input name="projectId" value="<?php echo $projectid;?>">
                            <input name="action" value="projectId" hidden>
                            <input name="action" value="projectId" hidden>
                            <button type="submit" value="<?php echo $projectid;?>">Add Task</button>
                        </form>
                    </td>
</div>
</div>
